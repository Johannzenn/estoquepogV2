<?php
    ...
    if (isset($_GET['tb_estoquepog'])){
        $tb_estoquepog = $_GET['tb_estoquepog'];
    }
    else{
        header("Location: index.php");
    }
    
    $tabela = $pdo->prepare("SELECT * FROM tb_estoquepog WHERE id_prod=:id_prod;");
    $tabela->execute(array(':tb_estoquepog'=>$tb_estoquepog));
            ...
            <form action="CRUD/update_prod.php" method="post" id="formulario">
                ...
                <div class="form-group offset-md-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="desc_prod" id="" class="form-control" value=<?php echo $rowTable[0]['desc_produto']?>>
                    </div>
                </div>
                <div class="form-group offset-md-3">
                    <div class="col-md-6">
