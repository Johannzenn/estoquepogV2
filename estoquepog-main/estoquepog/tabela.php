<?php
    ...
    $tabela = $pdo->prepare("SELECT id_prod, name_prod, qtd_prod, desc_prod, cat_prod 
    FROM tb_estoquepog;");
    $tabela->execute();
    ...
    <body>
        ...
        <tbody>
            ...
            foreach ($rowTabela as $linha){
                ...
                echo '<td><a href=edit_tabela.php?produto='.$linha['id_prod'].' class="btn btn-warning">Editar</a></td>';
                echo '<td><a href=CRUD\del_prod.php?produto='.$linha['id_prod'].' class="btn btn-danger">Excluir</a></td>';
                echo '</tr>';
            }
            ?>
        </tbody>
